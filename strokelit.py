...
#remove hypertension, heart_disease for more honest modeling
...
if page == "Home":
    ...
    st.subheader("I made an app to predict stroke outcomes")
    st.write("""
        This app provides an interactive platform to explore the strok prediction dataset. 
    ...
    """)
    st.image('https://storage.googleapis.com/kaggle-datasets-images/1120859/1882037/04da2fb7763e553bdf251d5adf6f88d9/dataset-cover.jpg?t=2021-01-26-19-57-05', caption="Kaggle Picture")
    
    st.subheader("About the Data")
    st.write("""
             According to the World Health Organization (WHO) stroke is the 2nd leading cause of death globally, responsible for approximately 11 percent of total deaths. This dataset is used to predict whether a patient is likely to get stroke based on the input parameters like gender, age, various diseases, and smoking status. Each row in the data provides relavant information about the patient.
    """)
    st.link_button("Kaggle Dataset Reference", 'https://www.kaggle.com/datasets/fedesoriano/stroke-prediction-dataset')
...
# Exploratory Data Analysis (EDA)
    ...
    # st.write(f"The average age of stroke victims is {df['age'].mean():.2f} years. Females comprise of {percent_female:.2f}% of passengers.")
